    ...
    for epoch in range(args.epochs):
        ...
        if val_loss < best_val_loss:
            ...
            if args.net == 'LegendreNet':
                TEST1 = tmp_net.prop1.temp.clone()
                # TEST2 = tmp_net.prop1.variables.clone()
                theta = TEST1.detach().cpu()
                # gamma = TEST2.detach().cpu()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', type=str, choices=['GCN', 'GAT', 'APPNP', 'ChebNet', 'GPRGNN', 'BernNet', 'MLP', 'HermiteNet' ],
                        default='HermiteNet')
    ...
    for RP in tqdm(range(args.runs)):
        ...
        if args.net == 'LegendreNet':
            ...
            # print('Gamma:', [float('{:.4f}'.format(i)) for i in gamma_0])
